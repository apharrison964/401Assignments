...
class SoundStreamPlayer {
      ...
      try {
        ...
        if (cmd.equals("quit")) {
          ...
          System.out.println("[Wave]: Set playback mode to RANDOM.");
        	  ...
        	  control.setMode(Control.Mode.LOOP);
        	  System.out.println("[Wave]: Set playback mode to LOOP");
  ...
  private void helpHandler() {
    ...
    System.out.format("%10s: Set playback mode to LOOP.%n", "loop");
  }
