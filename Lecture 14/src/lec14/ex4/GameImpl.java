...
public class GameImpl extends Observable implements Game {
	...
	public void scorePoints(String team, int points_to_add) {
		...
		setChanged();  // This is how the parent class can be told that something abservable has changed about the object, use when using the
		// built in observer-observable, need to do this before notify observers
