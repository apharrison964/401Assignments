	...
	public static void main(String[] args) {
		...
		while (sc.hasNext()) {
			...
			*/
			...
			Triangle t = new Triangle(ax, ay, bx, by, cx, cy); //Providing the six #s
...
/* Class names are type names, created triangle class to use objects of the type
triangle
You can now move the code into the definition of that kind of obtion, this is step 
4, definging the instance methods
*/