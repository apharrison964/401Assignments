...
public class StudentImpl implements Person, Student {
	...
	public StudentImpl(String first, String last) {
		this(first, last, "Address Unknown"); // constructor chainging, uses this to chain
	}
	...
	public Status getStatus() { // to refer to an enumeration, you use the name of the enumeration.symbol
		if (credits < 30) {
